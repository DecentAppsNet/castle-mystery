...
import FacingEvent, { duplicateFacingEvent } from "./FacingEvent";
...
type ItineraryEvent = WalkEvent | RoomEntryEvent | SpeechEvent | CharacterEncounterEvent | FacingEvent | TakeItemEvent | DropItemEvent | GiveItemEvent;
...
export function duplicateItineraryEvent(from:ItineraryEvent):ItineraryEvent {
  switch(from.type) {
    ...
    case ItineraryEventType.FACING: return duplicateFacingEvent(from as FacingEvent);

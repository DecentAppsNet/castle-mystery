...
describe('canvasLayoutPlanner', () => {
  describe('reserveRect()/findBestPopoverRect()', () => {
    it('places a popover centered below the anchor when no reserved rect overlaps', () => {
    ...
    it('treats contained reserved rects as overlaps', () => {
      ...
      expect(planner.findBestPopoverRect({ x:70, y:35, width:40, height:15 }, 60, 30)).toEqual({
        x:60,
        y:20,
        width:60,
        height:30

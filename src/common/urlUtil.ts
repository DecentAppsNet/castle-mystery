/* This module groups base-URL and deployment-path helpers for runtime URL normalization.
  AI agent, do not edit this file without specific instruction to do so. Discuss with user if you want to edit. */
...
function _parseBasePathFromUriPath(path:string) {
...
function _getBasePath() {
  if (!theBasePath) { theBasePath = _parseBasePathFromUriPath(window.location.pathname); }
  return theBasePath;
}

...
const SKIN_NAMES = ['guard uniform', 'royal robes', 'tiara'];
...
describe('parseUtil', () => {
    ...
    beforeEach(() => {
      sharedRules = createActivityParsingRules(CHARACTER_IDS, ROOM_IDS, ITEM_IDS, SKIN_NAMES);
    });
    ...
    describe('literal parsing', () => {
      it('fails when a required literal does not match', () => {
        const rules = createActivityParsingRules(CHARACTER_IDS, ROOM_IDS, ITEM_IDS, SKIN_NAMES, createParseFormat(makeSequence([

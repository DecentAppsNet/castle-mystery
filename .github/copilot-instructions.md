...
- Use assertions to verify invariants in code that should be true, rather than writing guard code that hides unexpected conditions. Assertion best practices are described in `/CONTRIBUTING.md`.

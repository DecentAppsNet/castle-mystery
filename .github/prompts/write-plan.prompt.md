...
- Before writing, check whether the intended path already exists.
- If replacing an existing plan, update that file in place. Do not delete and add the same path in one patch operation.

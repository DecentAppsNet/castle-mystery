...
DO: If the requirements and design input are unclear, stop and discuss before continuing.
DO: If you think I may not understand something important, stop and discuss before continuing.
DO: If you feel the plan would benefit from changes that may be substantial, stop and discuss before continuing. But also understand that refinements can be made to the plan itself in conversation after the plan file ahs been created.
...
* DO: Include a "Phase 0" section that establishes a good starting baseline (clean worktree, build passes, tests pass) before changes are made.
